...
import { Mail, Lock, ArrowLeft, Github, CheckCircle } from "lucide-react";
import Link from "next/link";

export default function SignUpPage() {
  const router = useRouter();
  const { signUpWithEmail, signInWithOAuth, isAuthenticated, isLoading } =
    useSupabase();
  ...
  return (
    <>
      <Head>
        <title>Sign Up - Peta Malaysia</title>
      </Head>
